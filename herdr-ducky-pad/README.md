...
**Flash it — no Keil, no toolchain needed.** The pre-built **v3.1.23-herdr**
...
The OLED boot screen shows `duckyPad V3.1.23` once it's running. The full
...
Firmware 3.1.23+ **requires a microSD card with a selected Herdr profile**.
