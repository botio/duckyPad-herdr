...
**Flash it — no Keil, no toolchain needed.** The pre-built **v3.1.31-herdr**
...
The OLED boot screen shows `duckyPad V3.1.31` once it's running. The full
...
Firmware 3.1.31+ **requires a microSD card with a selected Herdr profile**.
